...
/**
 * Squiggly Slider — ported from Meld (Metrolist) which itself ports it from
 * the mpvEx project (https://github.com/marlboro-advance/mpvEx).
 *
 * A continuously scrolling wavy line where the wave height animates to 0 when
 * paused or while dragging, and back to full height when playing.
 */
@Composable
fun SquigglySlider(
    value: Float,
